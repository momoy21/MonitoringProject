     ...
     <div class="nonsticky-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end">
                <a href="{{ route('kondisiproyek.index') }}" class="btn btn-outline-secondary" onclick="if(window.StateManagers?.kondisiProyek) window.StateManagers.kondisiProyek.markForRestore();">
