<x-layout title="Spesifikasi RAB">
    <!-- Header Section - Sticky -->
    <div class="sticky-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h4 class="fw-bold mb-2">Spesifikasi RAB</h4>
                <p class="mb-0">Kelola data spesifikasi RAB sistem</p>
            </div>
    ...
    <!-- Table Section -->
    <div class="card">
        <div class="table-responsive spesifikasirab-table-container">
            <table class="table table-striped table-hover spesifikasirab-table">
                <thead>
                    <tr>
                        <th class="fw-bold">ID Spec</th>
                        {{-- <th class="fw-bold">ID Spec</th> --}}
                        <th class="fw-bold">Spesifikasi RAB</th>
                ...
                <tbody id="spesifikasiRABTableBody">
                    ...
                    <tr>
                        ...
                        {{-- <td>
                            <span class="id_spec-value">{{ $item->id_spec }}</span>
                        </td> --}}
                        <td>
                            <div class="truncate-text" title="{{ $item->spec_rab }}">
                                {{ $item->spec_rab }}
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item text-danger" href="javascript:void(0);" onclick="deleteSpesifikasiRAB('{{ $item->id_spec }}')">
   ...
   <div class="pagination-controls d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mt-3 gap-2" id="paginationControls">
       ...
       <div class="pagination-info">
           <span class="text-muted medium">
               Menampilkan <span id="entriesFrom">{{ $spesifikasirab->firstItem() ?? 0 }}</span> hingga <span id="entriesTo">{{ $spesifikasirab->lastItem() ?? 0 }}</span> dari <span id="entriesTotal">{{ $spesifikasirab->total() }}</span> data
           </span>
       </div>
    ...
    <!-- Modals -->
    <!-- View Modal -->
    <div class="modal fade" id="viewSpesifikasiRABModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Spesifikasi RAB</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body" id="viewSpesifikasiRABContent">
    ...
    $(document).ready(function() {
        ...
        window.spesifikasiRABManager.init({
            pageType: 'index',
            currentPage: {{ $spesifikasirab->currentPage() }},
            totalPages: {{ $spesifikasirab->lastPage() }},
