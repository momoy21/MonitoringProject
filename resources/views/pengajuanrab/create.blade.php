<x-layout title="Tambah Pengajuan RAB">
    ...
    <div class="nonsticky-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h4 class="fw-bold mb-2">Form Input Pengajuan RAB</h4>
                <p class="mb-0">Lengkapi form di bawah untuk mengajukan Rencana Anggaran Biaya</p>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <form id="pengajuanRabForm" method="POST" action="{{ route('pengajuanrab.store') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Tanggal dibuat otomatis</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Format: YYYYMMNN (auto-generate)</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('cost_center') is-invalid @enderror"
                                       id="cost_center" name="cost_center" value="{{ old('cost_center') }}"
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('nama_project') is-invalid @enderror"
                                          ...
                                          placeholder="Masukkan nama proyek" required>{{ old('nama_project') }}</textarea>
                                @error('nama_project')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('divisi') is-invalid @enderror"
                                    ...
                                    @foreach($divisi as $d)
                                        <option value="{{ $d->kode_divisi }}" {{ old('divisi') == $d->kode_divisi ? 'selected' : '' }}>
                                            {{ $d->nama_divisi }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <!-- Keterangan RAB -->
                <div class="form-section">
                    <h6 class="mb-3"><i class="bx bx-info-circle me-2"></i>Keterangan RAB</h6>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('keterangan') is-invalid @enderror"
                                    ...
                                    <option value="P" {{ old('keterangan') == 'P' ? 'selected' : '' }}>Pleno</option>
                                    <option value="T" {{ old('keterangan') == 'T' ? 'selected' : '' }}>Tidak Pleno</option>
                                    <option value="R" {{ old('keterangan') == 'R' ? 'selected' : '' }}>Revisi RAB</option>
                                </select>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
    ...
    function removeFile(type) {
        ...
        document.getElementById(type + 'FileInfo').classList.add('d-none');
        document.getElementById(boxMap[type]).style.display = 'block';
    }
    ...
    function resetForm() {
        ['rab', 'kontrak', 'petaRisk'].forEach(type => removeFile(type));
    }
    </script>
    @endpush
</x-layout>
