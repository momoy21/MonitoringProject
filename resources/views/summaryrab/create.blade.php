<x-layout title="Tambah Summary RAB">
    <x-slot name="breadcrumbs">
        @php
        $breadcrumbs = [
            ['name' => 'Summary RAB', 'url' => route('summaryrab.index')],
            ['name' => 'Tambah Summary RAB']
        ];
        @endphp
    </x-slot>
    ...
    <div class="nonsticky-header">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h4 class="fw-bold mb-2">Tambah Summary RAB Baru</h4>
                <p class="mb-0">Lengkapi form di bawah untuk menambah summary RAB baru</p>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <form id="summaryRABForm" method="POST" action="{{ route('summaryrab.store') }}">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('norutsummary') is-invalid @enderror"
                                       ...
                                       value="{{ old('norutsummary', $nextNorutSummary) }}"
                                       maxlength="2"
                                       required>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('ketsummaryrab') is-invalid @enderror"
                                          ...
                                          maxlength="100"
                                          required>{{ old('ketsummaryrab') }}</textarea>
